...
Мы долгое время использовали quicktemplate для создания JSON документов для обмена данными между микросервисами в
...
разработана как замена со сравнимой скоростью и динамическими возможностями. Соответственно она во многом она следует
синтаксису qtpl.
...
Для типобезопасного вывода существуют специальные модификаторы. Их надо указывать до инструкции вывода `=`:
